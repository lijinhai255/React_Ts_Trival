...
export const Header: React.FC = () => {
  ...
  // 获取购物车  信息
  const shoppingCartItems = useSelector(e=>e.shoppingCart.items)
  const shoppingCartLoading = useSelector(e=>e.shoppingCart.loading)
  useEffect(() => {
    if (jwt) {
        ...
        <div className={styles.inner}>
          ...
          {jwt ? (
            <Button.Group className={styles["button-group"]}>
              ...
              >
                {t("header.shoppingCart")}({shoppingCartItems&&shoppingCartItems.length})
                </Button>
